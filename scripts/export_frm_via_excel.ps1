...
#
# Exemple :
#   .\scripts\export_frm_via_excel.ps1 -SrcFrm "src\frmNettoyage.frm" `
#       -OutDir "src" -FormName "frmNettoyage"
param(
    [string]$SrcFrm   = "src\frmNettoyage.frm",
    [string]$OutDir   = "src",
    [string]$FormName = "frmNettoyage"
)
